...
#ifndef PMERGEME_SIMD_UNROLL
#define PMERGEME_SIMD_UNROLL 0
#endif
...
static const uint64_t jacobsthal_table[] = {0,
                                            1,
                                            1,
                                            3,
                                            5,
...
struct PairSoA {
  ...
  explicit PairSoA(size_t pair_count) : lower(pair_count), upper(pair_count) {}
...
size_t find_insertion_position(const std::vector<int> &arr, size_t size,
                               int value);
std::vector<int> ford_johnson_sort_soa(PairSoA pairs, int straggler,
                                       bool has_straggler);
std::vector<int> ford_johnson_sort(const std::vector<int> &values,
                                   int straggler, bool has_straggler);
std::deque<int> ford_johnson_sort_deque(const std::deque<int> &values,
                                        int straggler, bool has_straggler);
